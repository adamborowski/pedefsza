...
class TariffController extends Controller implements ClassResourceInterface
{
    public function cgetAction(Request $request)
    {
        $em = $this->getDoctrine()->getManager();

        $entities = $em->getRepository('ReportBundle:Tariff')->findAll();
    ...
    protected function getEntity($id)
    {
        ...
        $entity = $em->getRepository('ReportBundle:Tariff')->find($id);
